<script lang="ts">
    ...
    // tap-only controls shared with the create dialog
    ...
    const val: UpdateDiscountReq = {
        ...
        record: {
            ...discount.record,
            amount: discount.record.type === "Percentage" ? discount.record.amount * 100 : discount.record.amount,
        },
        status: {
            ...discount.status
        }
        ...
        <Dialog.Header>
            ...
            <Dialog.Description>
                <div class="flex flex-col gap-4">
                    ...
                    <hr>
                    <SlotMatchers bind:this={slotMatchers} seed={discount.record} open={dialogOpen}/>
                    <hr>
